      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md glass-card bg-[#0a0a0a] border-red-500/30 overflow-hidden shadow-2xl"
          >
            <div className="p-8 space-y-8">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-black text-white font-display">Reset Examora Data?</h3>
              ...
              <div className="bg-red-500/5 border border-red-500/10 rounded-2xl p-6 space-y-3">
                <div className="flex items-center gap-3 text-xs font-bold text-red-400 uppercase tracking-widest">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={onClose}
                  disabled={isLoading}
                  className="flex-1 px-6 py-4 rounded-2xl bg-white/5 hover:bg-white/10 text-white font-black transition-all border border-white/10 uppercase tracking-widest text-xs"
                >
                  Cancel
                </button>
                <button
